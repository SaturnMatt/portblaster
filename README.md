...
Pass a fourth argument to validate large-file behavior, and a fifth argument of `1` to validate expanded MIME types:

```powershell
.\build\pbjelly\pbjelly.exe 127.0.0.1 8083 build\pbjelly\public\jelly-report.html 413 1
```
